...
How do we increase efficiency? First, let's think about why our default Python code is slow
...
The first approach we take to tackling these issues is by using Numba, a just-in-time (JIT) compiler for Python that compiles Python bytecode to machine code at runtime.
